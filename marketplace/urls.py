...
from .views import (
    ...
    DispatchScanBulkByTrackingView,
...
urlpatterns = [
    ...
    path("reports/tracking/<int:batch_id>/", TrackingReportView.as_view(), name="mp-report-tracking"),
    path("reports/<slug:report_type>/preview/", ReportPreviewView.as_view(), name="mp-report-preview"),
