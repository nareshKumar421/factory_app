...
from .views_sales_dispatch import (
    ...
    SalesDispatchBoxScanBulkDeleteView,
    SalesDispatchBoxScanListCreateView,
    SalesDispatchPalletScanView,
...
urlpatterns = [
    ...
    path('sales-dispatch/columns/', SalesDispatchColumnValuesView.as_view(), name='sales_dispatch_column_values'),
    ...
    path('sales-dispatch/expected-vehicles/', SalesDispatchExpectedVehicleListView.as_view(), name='sales_dispatch_expected_vehicles'),
    ...
    path('sales-dispatch/<int:entry_id>/pallet-scan/', SalesDispatchPalletScanView.as_view(), name='sales_dispatch_pallet_scan'),
    path('sales-dispatch/<int:entry_id>/box-scans/bulk-delete/', SalesDispatchBoxScanBulkDeleteView.as_view(), name='sales_dispatch_box_scans_bulk_delete'),
